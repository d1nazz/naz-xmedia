    ...
    <PageLayout>
      <div className="container mx-auto px-6 py-12 max-w-4xl">
        <div className="animate-fade-in">
          <h1 className="text-5xl font-bold mb-6 glow-text">Fulfillment Policy</h1>
          ...
          <Card className="p-12 surface-elevated border-border/50 text-center">
            <div className="max-w-2xl mx-auto space-y-6">
              ...
              <p className="text-muted-foreground text-lg leading-relaxed">
                Our comprehensive fulfillment policy is currently being prepared to ensure we
                provide you with complete transparency and clarity regarding our service delivery
                standards.
              </p>
